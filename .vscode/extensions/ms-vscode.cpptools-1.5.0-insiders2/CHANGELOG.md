...
* Fix configuration squiggle on a recursively resolved `forcedInclude`. [PR [#7722](https://github.com/Microsoft/vscode-cpptools/issues/7722)](https://github.com/microsoft/vscode-cpptools/pull/7722)
