...
function createCommands(ctx, kpmController) {
    ...
    cmds.push(vscode_1.commands.registerCommand("codetime.createTeam", () => {
        Util_1.launchWebUrl(Constants_1.create_team_url);
    }));
    ...
    cmds.push(vscode_1.commands.registerCommand("codetime.showTeamDashboard", (org_name, team_id) => {
        // i.e. https://app.software.com/dashboard?org_name=swdotcom&team_id=11
        Util_1.launchWebUrl(`${Constants_1.launch_url}/dashboard?org_name=${org_name}&team_id=${team_id}`);
    }));
    ...
    cmds.push(vscode_1.commands.registerCommand("codetime.reloadTeams", () => __awaiter(this, void 0, void 0, function* () {
        yield TeamManager_1.buildTeams();
        vscode_1.commands.executeCommand("codetime.refreshCodeTimeView");
    })));
