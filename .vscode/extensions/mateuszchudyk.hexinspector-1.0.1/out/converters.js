...
function hexToBytes(str, little_endian = true) {
    if (!str) {
        return undefined;
    }
...
function bytesToUnsignedDec(bytes) {
    if (bytes.length == 0) {
        return '';
    }
...
exports.bytesToUnsignedDec = bytesToUnsignedDec;
function bytesToSignedDec(bytes) {
    if (bytes.length == 0) {
        return '';
    }
...
exports.bytesToSignedDec = bytesToSignedDec;
...
exports.bytesToFloat16 = bytesToFloat16;
...
exports.bytesToFloat64 = bytesToFloat64;
