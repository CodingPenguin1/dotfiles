...
class MusicPlaylistManager {
    ...
    createPlaylist(playlistName, playlistTrackItems) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (errMsg) {
                vscode_1.window.showErrorMessage(`There was an unexpected error adding tracks to the playlist. ${errMsg} Refresh the playlist and try again if you feel the problem has been resolved.`, ...[view_constants_1.OK_LABEL]);
                return;
            }
            ...
            if (playlist_id) {
                ...
                if (addTracksResult.state === cody_music_1.CodyResponseType.Success) {
                    ...
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (playlist_id === view_constants_1.SPOTIFY_LIKED_SONGS_PLAYLIST_NAME) {
                            yield PlaylistDataManager_1.populateLikedSongs();
                        }
                        else {
                    ...
                    vscode_1.window.showErrorMessage(`There was an unexpected error adding tracks to the playlist. ${addTracksResult.message}`, ...[view_constants_1.OK_LABEL]);
                }
            }
        });
    }
