...
class MusicTimeWebviewSidebar {
    ...
    refresh(tab_view = undefined, playlist_id = undefined, loading = false) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._webview) {
                // its not available to refresh yet
                return;
            }
            this._webview.webview.html = yield this.getReactHtml(tab_view, playlist_id, loading);
        });
    }
    get onDidClose() {
    ...
    loadWebview(tries = 10) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((FileManager_1.getItem("jwt") && musicInitialized) || tries <= 0) {
                this._webview.webview.html = yield this.getReactHtml(null, null, true);
            }
            else {
                tries--;
                setTimeout(() => {
    ...
    getReactHtml(tab_view = undefined, playlist_id = undefined, loading = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const reactAppPathOnDisk = vscode_1.Uri.file(path.join(__dirname, "webviewSidebar.js"));
            const reactAppUri = reactAppPathOnDisk.with({ scheme: "vscode-resource" });
            const stateData = JSON.stringify(yield ReactData_1.getReactData(tab_view, playlist_id, loading));
            return `<!DOCTYPE html>
		<html lang="en">
		<head>
			<meta charset="UTF-8">
