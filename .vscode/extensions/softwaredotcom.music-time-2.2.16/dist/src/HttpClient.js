...
exports.isResponseOk = exports.hasTokenExpired = exports.softwareDelete = exports.softwarePost = exports.softwarePut = exports.softwareGet = void 0;
...
beApi.defaults.headers.common["X-SWDC-Plugin-UUID"] = FileManager_1.getPluginUuid();
/**
 ...
 * @param jwt
 */
function softwareGet(api, jwt = null, additionHeaders = null) {
...
function softwareDelete(api, jwt) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return beApi
            ...
            .catch((err) => {
            console.debug(`error with delete request for ${api}, message: ${err.message}`);
            return err;
        });
    });
}
